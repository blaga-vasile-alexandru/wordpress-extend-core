...
const CardTemplate = $props => {
  console.info($props);
  const $classes = classnames__WEBPACK_IMPORTED_MODULE_1___default()($props.__unstableLayoutClassNames, {
    "block-wp-extend-core-card": true
  });
  const $blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: $classes
  });
  const $useInnerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)($blockProps, {});
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("article", $useInnerBlocksProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks, null));
};
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"title":"Card Template","version":"0.1.0","name":"wp-extend-core/card-template","category":"design","icon":"cover-image","textdomain":"card-list","editorScript":"file:./index.js","style":"file:./style-index.css","editorStyle":"file:./index.css","parent":["wp-extend-core/card-list"],"usesContext":["loopNumber"],"supports":{"reusable":false,"html":false,"align":false,"anchor":true,"__experimentalLayout":{"allowEditing":false},"defaultStylePicker":true,"color":{"background":true,"text":false},"spacing":{"margin":true,"padding":true},"alignWide":false,"typography":{"fontSize":true,"lineHeight":true}}}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkcard_template"] = globalThis["webpackChunkcard_template"] || [];
